...
export const ProfileController = {
  ...
  create: async (req: Request, res: Response, next: NextFunction) => {
    try {
      const { userId, avatar, bio, phone, address, birthDate, gender, website, socialMedia } = req.body;
      ...
      const newData = await Profile.create({ userId, avatar, bio, phone, address, birthDate, gender, website, socialMedia });
      res.status(201).json({ 
        status: 'success', 
  ...
  update: async (req: Request, res: Response, next: NextFunction) => {
    try {
      ...
      await data.update({ userId, avatar, bio, phone, address, birthDate, gender, website, socialMedia });
